class OrdersController < ApplicationController
  ...
  def create
    ...
    private
     ...
     def donation_params
       params.require(:furima_registration).permit(:postcode, :prefecture_id, :city, :block, :building, :phone_number).merge(user_id: current_user.id, item_id: params[:item_id],token: params[:token])
       #hogeを追加した。
     end
